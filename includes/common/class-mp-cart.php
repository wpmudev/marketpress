...
class MP_Cart {
	...
	public function cart_products_html($context = null) {
		if ( $this->has_items() ) {
			...
			if($context == "widget") {
				$html .= '
					<a class="mp_button mp_button-widget-cart mp-empty-cart" href="' . mp_store_page_url( 'cart', false ) . '">' . __( 'Empty Cart', 'mp' ) . '</a>
					<a class="mp_button mp_button-widget-cart" href="' . mp_store_page_url( 'checkout', false ) . '">' . __( 'Checkout', 'mp' ) . '</a>';
			} else {
				$html .= '
