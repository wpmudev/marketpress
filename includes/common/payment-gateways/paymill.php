		...
		$content = '
			...
			<div class="mp-checkout-form-row">
				<div class="mp-checkout-input-complex clearfix">
					...
					<div class="mp-checkout-column">
						<label>' . __( 'Security Code ', 'mp' ) . '<span class="mp-field-required">*</span> <span class="mp-tooltip-help"><img src="' . mp_plugin_url( 'ui/images/cvv_2.jpg' ) . '" alt="' . __( 'CVV2', 'mp' ) . '" /></span></label>
						<input
