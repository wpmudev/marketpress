...
class MP_Store_Settings_Shipping {
	...
	public function print_scripts() {
		if ( get_current_screen()->id != 'store-settings_page_store-settings-shipping' ) { return; }
		?>
	...
	public function add_metaboxes() {
		...
		$metabox->add_field('advanced_select', array(
			...
			'options' => mp_popular_country_list() + array('all_countries|disabled' => __('All Countries', 'mp')) + mp_country_list(),
