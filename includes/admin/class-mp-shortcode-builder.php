...
<div id="mp-shortcode-builder" style="display:none">
	<form id="mp-shortcode-builder-form">
		...
		<?php
		$this->display_shortcode_builder_form_buttons(); ?>
	</form>
</div>
		<?php
	}
			...
			<tr>
				...
				<td>
					<select name="orderby" data-default="name">
						<?php
						foreach ( array('ID', 'name', 'slug', 'count', 'term_group') as $value ) : ?>
			...
			<tr>
				...
				<td>
					<select name="order" data-default="list">
						<?php
						foreach ( array('list', 'none') as $value ) : ?>
	...
	public function enqueue_styles_scripts() {
		...
		wp_enqueue_script('colorbox', mp_plugin_url('ui/colorbox/jquery.colorbox-min.js'), false, '1.5.10');
